...
pub fn get_mock_playlists() -> Vec<Playlist> {
    vec![
        Playlist {
            ...
            images: vec![],
            tracks: PlaylistTracks { total: 25, href: None },
            external_urls: ExternalUrls {
                spotify: "https://open.spotify.com".to_string(),
            },
            owner: PlaylistOwner {
            ...
            uri: Some("spotify:playlist:playlist1".to_string()),
        },
        Playlist {
            ...
            images: vec![],
            tracks: PlaylistTracks { total: 40, href: None },
            external_urls: ExternalUrls {
                spotify: "https://open.spotify.com".to_string(),
            },
            owner: PlaylistOwner {
            ...
            snapshot_id: None,
            playlist_type: Some("playlist".to_string()),
            uri: Some("spotify:playlist:playlist2".to_string()),
        },
    ]
}
